...
- **Social Desirability Bias**: The tendency of respondents to answer questions in a manner that will be viewed favorably by others, often leading to overreporting of socially desirable behaviors and underreporting of undesirable ones [@fowler1995].

- **Acquiescence Bias**: Also known as "yea-saying," this is the inclination of respondents to agree with statements regardless of their content, resulting in a disproportionate number of affirmative answers [@converse1986].

- **Extreme Response Bias**: The propensity to use the extreme ends of a response scale, such as "strongly agree" or "strongly disagree," more frequently than the middle options, which can skew the data toward more polarized responses [@fowler1995].

- **Moderacy Bias**: The tendency to avoid extreme responses and consistently select middle or neutral options on a scale, potentially masking true variations in opinions or behaviors [@converse1986].

- **Question Order Bias**: Occurs when the sequence of questions influences responses, as earlier questions can provide context that affects answers to subsequent ones [@fowler1995].

- **Nonresponse Bias**: Arises when certain groups are underrepresented because they are less likely to respond to surveys, leading to results that do not accurately reflect the target population [@converse1986].
